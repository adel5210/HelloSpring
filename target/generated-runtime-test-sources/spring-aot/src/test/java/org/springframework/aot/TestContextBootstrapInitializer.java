...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.adel.hellospring.HelloSpringApplicationTests", () -> new AotSpringBootConfigContextLoader(HelloSpringApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.adel.hellospring.HelloSpringApplicationTests", HelloSpringApplicationTestsContextInitializer.class);
    return entries;
  }
}
